...
export type WorkflowDetail = { name: string; path?: string; api_version?: string; lint?: { ok?: boolean } };
...
export type RunSummary = { run_id: string; workflow_name?: string; status?: string };
