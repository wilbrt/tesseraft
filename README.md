...
- **fragment-package-contract** (implemented) — First-class fragment packages (`tesseraft.fragment/v1`): EDN/JSON-normalized boundary contract linting, JSON-compatible portable projection, `bb fragment lint|import`, deterministic scope/version/input/parameter/prefix inclusion contracts, and derived effective inclusion inspection data. Inclusion lints the boundary without duplicating internal proof.
