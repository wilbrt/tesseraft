...
- **fragment-package-contract** (implemented) — First-class fragment packages (`tesseraft.fragment/v1`): EDN/JSON-normalized boundary contract linting, JSON-compatible portable projection, `bb fragment lint|import`, scope model, and fixtures. Inclusion lints the boundary without duplicating internal proof.
  _Evidence:_ src/tesseraft/spec.clj read-fragment-package/portable-fragment-package-data, src/tesseraft/fragment/cli.clj, src/tesseraft/lint/core.clj lint-fragment-package, docs/FRAGMENTS.md, schemas/fragment-package.schema.json, examples/fragments/test-fix-loop/fragment.edn, test/fixtures/valid/fragment-parity/fragment.{edn,json}, test/fixtures/invalid/fragment-parity/fragment.{edn,json}, test/fragment_package_parity.test.py, bb.edn :fragment
