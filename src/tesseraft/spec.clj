...
(def default-known-handlers
  #{:jira/fetch-ticket :git/ensure-branch :git/ensure-worktree :git/push :github/create-pr :github/fetch-pr-feedback :web/start-test-server :notify/pinga :noop/succeed})
