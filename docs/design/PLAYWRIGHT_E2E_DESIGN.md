...
Supersedes: Manual-only browser regression coverage
Superseded by: —
...
[`code-review-loop`](../../examples/catalog/code-review-loop/workflow.edn), one focused
pull request, and an independent regression and code-review decision.

It extends the Web UI boundaries in [WEB_UI.md](../reference/WEB_UI.md), the architecture in
[WEB_UI_ARCHITECTURE.md](../architecture/WEB_UI_ARCHITECTURE.md), and the browser-only gaps in
...
```text
Implement PW1 from docs/design/PLAYWRIGHT_E2E_DESIGN.md: add the pinned Playwright
...
```text
Implement PW2 from docs/design/PLAYWRIGHT_E2E_DESIGN.md: add the smallest isolated
...
```text
Implement PW3 from docs/design/PLAYWRIGHT_E2E_DESIGN.md using the existing isolated
...
```text
Implement PW4 from docs/design/PLAYWRIGHT_E2E_DESIGN.md with the isolated run fixture.
...
```text
Implement PW5 from docs/design/PLAYWRIGHT_E2E_DESIGN.md. In an isolated workspace, add
...
```text
Implement PW6 from docs/design/PLAYWRIGHT_E2E_DESIGN.md. Add focused Playwright
...
```text
Implement PW7 from docs/design/PLAYWRIGHT_E2E_DESIGN.md using isolated local fixtures.
