...
- **Self-checkpoint approvals:** runtime approval support landed in PR #44
  ...
  control plane, not browser-only forms. The remaining work is the diff-centric
  self-checkpoint UI (P3.1).
