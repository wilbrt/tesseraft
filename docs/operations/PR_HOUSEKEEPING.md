...
`examples/catalog/pr-housekeeping/workflow.edn` is the safe first slice of a maintainer workflow for open pull requests.
...
```bash
./bin/tesseraft lint examples/catalog/pr-housekeeping/workflow.edn
./bin/tesseraft run examples/catalog/pr-housekeeping/workflow.edn \
