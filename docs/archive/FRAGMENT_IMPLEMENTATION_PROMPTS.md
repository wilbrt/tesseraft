...
Delivery workflow: [`canon-tdd-to-pr`](../guides/CANON_TDD_WORKFLOW.md)

Current contract/state: [`FRAGMENTS.md`](../reference/FRAGMENTS.md)

This document decomposes executable fragments into focused, dependency-ordered increments. Submit one prompt at a time to `examples/catalog/canon-tdd-to-pr/workflow.edn`. Merge each accepted PR before starting a dependent prompt so later test lists are based on the actual preceding contract.
...
```bash
./bin/tesseraft run start examples/catalog/canon-tdd-to-pr/workflow.edn \
  --run-id <id> \
  --input repo-root=. \
...
```text
Implement FI1 from docs/archive/FRAGMENT_IMPLEMENTATION_PROMPTS.md. Harden the
...
```text
Implement FI2 from docs/archive/FRAGMENT_IMPLEMENTATION_PROMPTS.md. Add a single
...
```text
Implement FI3 from docs/archive/FRAGMENT_IMPLEMENTATION_PROMPTS.md. Make fragment
...
```text
Implement FI4 from docs/archive/FRAGMENT_IMPLEMENTATION_PROMPTS.md. Project a
...
```text
Implement FI5 from docs/archive/FRAGMENT_IMPLEMENTATION_PROMPTS.md. Make `tesseraft
...
```text
Implement FI6 from docs/archive/FRAGMENT_IMPLEMENTATION_PROMPTS.md. Add the smallest
...
```text
Implement FI7 from docs/archive/FRAGMENT_IMPLEMENTATION_PROMPTS.md. Extend the FI6
...
```text
Implement FI8 from docs/archive/FRAGMENT_IMPLEMENTATION_PROMPTS.md. Make non-approval
...
```text
Implement FI9 from docs/archive/FRAGMENT_IMPLEMENTATION_PROMPTS.md. Support an approval
...
```text
Implement FI10 from docs/archive/FRAGMENT_IMPLEMENTATION_PROMPTS.md. Expose read-only
...
```text
Implement FI11 from docs/archive/FRAGMENT_IMPLEMENTATION_PROMPTS.md. Turn the
...
```text
Implement FI12 from docs/archive/FRAGMENT_IMPLEMENTATION_PROMPTS.md. Add a Studio
...
```text
Implement FI13 from docs/archive/FRAGMENT_IMPLEMENTATION_PROMPTS.md. Add pure,
