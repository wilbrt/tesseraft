...
- In-repo canon: `docs/reference/WEB_UI.md`, `docs/guides/WEB_UI_USE_CASES.md`,
  `docs/architecture/WEB_UI_ARCHITECTURE.md`, `docs/reference/CONTROL_PLANE_API.md`
...
- **Mock executor landed**: PR #8 merged; runner-level mock/dry-run mode
  ...
  `test/cli_contracts.test.py` mock dry-run). Remaining work: one-key mock-run UI (P2.2),
...
- **Prompt:**
  > Update `docs/reference/WEB_UI.md`, `docs/guides/WEB_UI_USE_CASES.md`,
  > `docs/architecture/WEB_UI_ARCHITECTURE.md`, and `docs/reference/CONTROL_PLANE_API.md` to reflect
...
- **Status:** ✅ Done — PR #8 (`agent/add-dry-run-mode`) merged to main
  ...
  `test/cli_contracts.test.py` (isolated mock-executor fixture).
- **Prompt:**
...
- **Status:** ✅ Done — PR #44 merged to main. Blocked run state, approval
  ...
  are retained (`test/web-server.test.js`, `test/runtime_cli_contracts.test.py`).
- **Prompt:**
