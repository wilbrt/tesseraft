...
(deftest executor-catalog-makes-unavailable-support-honest
  ...
  (is (executors/supports-session-resume? :pi-cli))
  (is (executors/supports-session-resume? :opencode-cli))
  (is (executors/supports-session-resume? :claude-code))
  (is (= :preallocated (executors/session-reference-allocation :pi-cli)))
  (is (= :executor-emitted (executors/session-reference-allocation :opencode-cli)))
  (is (= :preallocated (executors/session-reference-allocation :claude-code)))
